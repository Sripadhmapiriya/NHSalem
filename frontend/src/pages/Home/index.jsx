              ...
              <div className="p-5 bg-slate-50 rounded-2xl border border-slate-200/80 flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="mt-0.5">
                    <a href="tel:+919500829167" className="text-primary font-bold text-[16px] hover:underline block leading-none m-0 p-0" title="Call Us" style={{ minHeight: '0', minWidth: '0' }}>
                      +91 95008 29167
                    </a>
                    <a href="https://wa.me/919500829167?text=Hi,%20I'd%20like%20to%20know%20more%20about%20your%20products" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-[11px] text-[#25D366] hover:underline font-bold transition-colors leading-none p-0" title="Chat on WhatsApp" style={{ minHeight: '0', minWidth: '0', marginTop: '4px', marginBottom: '0' }}>
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: '4px' }}>
